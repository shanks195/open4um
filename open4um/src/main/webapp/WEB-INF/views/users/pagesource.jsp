...
<div class="container">
	...
	<div class="row info-home">
        ...
        <!-- TOP SOURCE -->
        <div class="row">
            <div class="col-xl-8" id="id_source">
                <!-- END TOP SOURCE -->

                <!-- NEW SOURCE -->
                <div class="title-menu-home-center">
                    <h3 style="text-transform: uppercase;"><i class="fas fa-laptop-code"></i> TOP SOURCE ${ctgname}
                    </h3>
                </div>
            <div class="row">
                    ...
                    <div class="col-12">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                <li class="page-item" ><a class="page-link" href="${pageContext.request.contextPath}/category/${chothong}/<c:out value = '${item}'/>"><c:out value = "${item}"/></a></li>
                               </c:forEach>
                                <li class="page-item">
