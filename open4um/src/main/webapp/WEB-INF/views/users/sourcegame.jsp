            ...
            <div class="col-xl-5 text-center">
                <div class="item-panel-source">
                    <div  class="list_source">
                         <a href="<%=contextPath%>/sourceweb"><img src="<c:url value="/resources/images/source-web.png"/>" alt="Upload source" class="img-upload-source" /><br/> SOURCE WEB</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-5 text-center">
                <div class="item-panel-source">
                    <div class="list_source">
                     <a  href="<%=contextPath%>/sourcegame"><img src="<c:url value="/resources/images/source-game.png"/>" alt="Upload source" class="img-upload-source" /><br/> SOURCE GAME</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <nav aria-label="Page navigation example">
                            <ul class="pagination">
                                ...
                                <li class="page-item" ><a class="page-link" href="${pageContext.request.contextPath}/sourcegame/<c:out value = '${item}'/>"><c:out value = "${item}"/></a></li>
                               </c:forEach>
                                <li class="page-item">
